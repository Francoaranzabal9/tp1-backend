const commands = [
  ...
  { comando: "agregarLibro", descripcion: "Agrega un nuevo libro a la colección", parametros: ["titulo", "autor", "año", "genero"] },
  ...
  { comando: "actualizarLibro", descripcion: "Actualiza la información de un libro", parametros: ["id", "titulo", "autor", "año", "genero"] }
]
